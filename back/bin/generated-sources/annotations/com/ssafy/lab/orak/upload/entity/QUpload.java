...
public class QUpload extends EntityPathBase<Upload> {
    ...
    public final StringPath processingErrorMessage = createString("processingErrorMessage");

    public final EnumPath<com.ssafy.lab.orak.upload.enums.ProcessingStatus> processingStatus = createEnum("processingStatus", com.ssafy.lab.orak.upload.enums.ProcessingStatus.class);
